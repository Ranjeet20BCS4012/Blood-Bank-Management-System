...
<html lang="en">
		...
		<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="userlog/registration.php" ><span class="glyphicon glyphicon-user" style="color:#00A10F;"></span> Sign Up</a></li>
	...
	<footer class="page-footer font-small special-color-dark pt-4">
		...
		<div class="footer-copyright text-center py-3">© <?php echo date("Y"); ?>
		 Developed Ranjeet Singh V.Swaroopa Ayush Beniwal  Kunal
		</div>
		<!-- Copyright -->
